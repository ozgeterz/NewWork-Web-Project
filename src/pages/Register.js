...
const REGISTER_URL = 'Tbl_Kullanici/Create';
            ...
            {success ? (
                ...
                <section>
                    ...
                    <form onSubmit={handleSubmit}>
                        <label htmlFor="Ad">
                            Ad:
                            <FontAwesomeIcon icon={faCheck} className={validAd ? "valid" : "hide"} />
                            <FontAwesomeIcon icon={faTimes} className={validAd || !Ad ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="Ad"
                        ...
                        />
                        <p id="Ad" className={AdFocus && Ad && !validAd ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            4 ila 24 karakter.<br />
                            Bir harfle başlamalıdır.<br />
                        ...
                        <label htmlFor="Soyad">
                            Soyad:
                            <FontAwesomeIcon icon={faCheck} className={validSoyad ? "valid" : "hide"} />
                            <FontAwesomeIcon icon={faTimes} className={validSoyad || !Soyad ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="Soyad"
                        ...
                        />
                        <p id="uidnote" className={SoyadFocus && Soyad && !validSoyad ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            4 ila 24 karakter.<br />
                            Bir harfle başlamalıdır.<br />
                        ...
                        <label htmlFor="Telefon">
                            Telefon:
                            <FontAwesomeIcon icon={faCheck} className={validTelefon ? "valid" : "hide"} />
                            <FontAwesomeIcon icon={faTimes} className={validTelefon || !Telefon ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="text"
                            id="Telefon"
                        ...
                        />
                        <p id="uidnote" className={TelefonFocus && Telefon && !validTelefon ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            4 ila 24 karakter.<br />
                            Bir harfle başlamalıdır.<br />
                        ...
                        <label htmlFor="şifre">
                            Şifre:
                            <FontAwesomeIcon icon={faCheck} className={validŞifre ? "valid" : "hide"} />
                            <FontAwesomeIcon icon={faTimes} className={validŞifre || !Şifre ? "hide" : "invalid"} />
                        </label>
                        <input
                            type="Sifre"
                            id="Şifre"
                        ...
                        />
                        <p id="Şifrenote" className={ŞifreFocus && !validŞifre ? "instructions" : "offscreen"}>
                            <FontAwesomeIcon icon={faInfoCircle} />
                            8 ila 24 karakter.<br />
                            Büyük ve küçük harfler, bir sayı ve özel bir karakter içermelidir.<br />
                        ...
                        <button disabled={!validAd || !validŞifre? true : false}>Kayıt ol</button>
                    </form>
                    <p>
